...
For evaluation, simple change the training_indicator in [python script](https://github.com/DailyL/Modified-DDPG-car-following-model/carla-ros-bridge/catkin_ws/src/ros-bridge/rl_agent/src/ddpg.py) into 0, and then run 
