...
echo_and_run cd "/home/dianzhaoli/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_waypoint_publisher"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/dianzhaoli/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_waypoint_publisher/setup.py" \
     \
    build --build-base "/home/dianzhaoli/carla-ros-bridge/catkin_ws/build/ros-bridge/carla_waypoint_publisher" \
    install \
    --root="${DESTDIR-/}" \
