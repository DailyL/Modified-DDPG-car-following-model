...
def playGame(train_indicator=0):    #1 means Train, 0 means simply Run
    ...
    if load_weight :#Now load the weight
        ...
        try:
            actor.model.load_weights(current_path + "/src/model/model_for_pure_ddpg_continue/actormodel.h5")
            critic.model.load_weights(current_path + "/src/model/model_for_pure_ddpg_continue/criticmodel.h5")
            actor.target_model.load_weights(current_path + "/src/model/model_for_pure_ddpg_continue/actormodel.h5")
            critic.target_model.load_weights(current_path + "/src/model/model_for_pure_ddpg_continue/criticmodel.h5")
